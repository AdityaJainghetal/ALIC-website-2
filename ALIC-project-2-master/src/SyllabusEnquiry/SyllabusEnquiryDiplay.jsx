...
//     const api = "https://alic-website-2-1.onrender.com/register/allcontact";
...
//         try {
//             await axios.delete(`https://alic-website-2-1.onrender.com/register/alldelete/${id}`);
...
//         try {
//             await axios.put(`https://alic-website-2-1.onrender.com/register/update/${editData._id}`, formData);
//             setEditData(null);
...
const SyllabusEnquiryDisplay = () => {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://alic-website-2-1.onrender.com/register/alldelete/${id}`
      );
      fetchContacts();
    } catch (error) {
      console.error("Error deleting contact:", error);
  ...
  const handleUpdate = async () => {
    try {
      await axios.put(
        `https://alic-website-2-1.onrender.com/register/update/${editData._id}`,
        formData
      );
      setEditData(null);
      fetchContacts();
