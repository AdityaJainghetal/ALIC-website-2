...
const Sidebar = () => {
  ...
  const handleLogout = () => {
    ...
    // For example: clear local storage, session, etc.
  ...
  const menuItems = [
    ...
    },
    {
      name: 'WhatsNew', icon: <FiHelpCircle />, subItems: [
        ...
        {
      name: 'FAQ', icon: <FiHelpCircle />, subItems: [
        { to: '/faq', name: 'FAQ' },
  ...
  
    {
      ...
      {
      name: 'Syllabus', icon: <FiStar />, subItems: [
    ...
    
    {
      ...
      {
      name: 'Discount', icon: <FiBook />, subItems: [
        { name: 'Add Discount', to: '/discount' },
      ...
      {
      name: 'Refund', icon: <FiBook />, subItems: [
        { name: 'Refund', to: '/refund' },
        // { name: 'View Refund', to: '/refundshow' },

        // { name: 'View Discount', to: '/discountshow' },
      ]
    },
         {
      name: 'Dynamic', icon: <FiBook />, subItems: [
        { name: 'Dynamic', to: '/dynamic' },
        // { name: 'View Refund', to: '/refundshow' },
