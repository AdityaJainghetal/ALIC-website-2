...
// // import { FiEdit, FiTrash2, FiX, FiSave, FiPlus, FiExternalLink } from 'react-icons/fi';
...
// //   useEffect(() => {
// //     fetchStories();
// //     // Reset edit form state on initial load
...
// //     const confirm = window.confirm('Are you sure you want to delete this success story?');
// //     if (!confirm) return;
...
// //       // Update the state without needing to refresh
// //       if (editingStory) {
// //         setStories(prev => prev.map(story =>
// //           story._id === editingStory ? updatedStory : story
// //         ));
// //       } else {
// //         setStories(prev => [...prev, updatedStory]);
// //       }

// //       toast.success(`Success story ${editingStory ? 'updated' : 'created'} successfully`);
// //       setIsEditFormOpen(false);
// //       setEditingStory(null);
// //     } catch (err) {
// //       console.error('Error:', err.response?.data || err.message);
// //       toast.error(`Error ${editingStory ? 'updating' : 'creating'} success story: ${err.response?.data?.message || err.message}`);
// //     } finally {
...
// //           <h1 className="text-2xl md:text-3xl font-semibold text-gray-800">Success Stories Management</h1>
// //           <button
...
// //           <input
// //             type="text"
// //             placeholder="Search by student name or judicial..."
...
// //                     <div>
// //                   <label className="block text-sm font-medium text-gray-700 mb-1">altText</label>
// //                   <input
// //                     type="text"
// //                     name="altText"
...
// //                 <div>
// //                   <label className="block text-sm font-medium text-gray-700 mb-1">Judicial</label>
// //                   <input
// //                     type="text"
// //                     name="Judicial"
...
// //                   disabled={isSubmitting}
// //                 >
// //                   {isSubmitting ? 'Processing...' : (editingStory ? 'Update Story' : 'Create Story')}
