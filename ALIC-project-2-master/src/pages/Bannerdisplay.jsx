...
//       toast.success(`Banner ${editingBanner._id ? 'updated' : 'created'} successfully`);
//       setIsEditFormOpen(false);
//       loadData();
//     } catch (error) {
//       toast.error(`Failed to ${editingBanner._id ? 'update' : 'create'} banner`);
//     } finally {
...
//           <h1 className="text-2xl md:text-3xl font-semibold text-gray-800">Banner Management</h1>
//           <button
...
//         {/* Edit/Add Form - Appears below the table */}
//         {isEditFormOpen && (
