...
//   const [subsubCategories, setSubsubCategories] = useState([]);   //qqqqq

//   const [filteredSubCategories, setFilteredSubCategories] = useState([]);

//   const [filteredSubsubCategories, setFilteredSubsubCategories] = useState([]);  //Sub

//   const [loading, setLoading] = useState(false);
//   const [errors, setErrors] = useState({});

//   console.log(subsubCategories,'aaaaaaaaaaaaaaaaaassssssss')
...
//         console.log(response.data, ":KJHKJHJKH")
//         if (response.data) {
...
//   //       (subsubCat) => subsubCat.subCategory === formData.subCategory
//   //     );
...
// //     // Optional: Reset subsubCategory if it's not in the filtered list
...
// useEffect(() => {
//   if (formData.subCategory && subsubCategories.length > 0) {
//     // Find subcategory name from the ID
...
//  <div className="mb-8">
//           <h3 className="text-lg font-semibold mb-4 text-gray-700 border-b pb-2">Alt tag</h3>
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//             {basicInfoFields.map(renderInputField)}
//           </div>
//         </div>
...
//             Banner Images <span className="text-red-500">* </span> W:510px H:334px
//           </label>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      ...
      >
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Banner Images <span className="text-red-500">* </span> W:510px
            H:334px
          </label>
