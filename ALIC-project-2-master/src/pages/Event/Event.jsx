...
//           <div>
//             <label className="block text-gray-700 mb-2" htmlFor="subTitle">Sub Title</label>
//             <input
//               type="text"
//               id="subTitle"
//               name="subTitle"
...
//           <div>
//             <label className="block text-gray-700 mb-2" htmlFor="subTitle">altText</label>
//             <input
//               type="text"
//               id="altText"
//               name="altText"
...
//         <div className="mb-6">
//           <label className="block text-gray-700 mb-2" htmlFor="Slot">Available Slots</label>
//           <input
//             type="number"
//             id="Slot"
//             name="Slot"
...
//         <div className="mb-6">
//           <label className="block text-gray-700 mb-2">Images <span>( Width: 510px Height: 334px )</span></label>
//           <input
//             type="file"
//             multiple
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          <label className="block text-gray-700 mb-2">
            Images <span>( Width: 510px Height: 334px )</span>
          </label>
          <input
            type="file"
            multiple
